...
def test_sharpen_image(sample_image):
    ...
    assert processed_img.shape == sample_image.shape # Check if the shape of the processed image is the same as the original image
    assert processed_img.dtype == sample_image.dtype # Check if the datatype of the processed image is the same as the original image
